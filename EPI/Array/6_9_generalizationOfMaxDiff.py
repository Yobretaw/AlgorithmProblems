...
def maxProfit2(prices, k):
    """
        ...
        to i-th day and buy at i-th day. Defind S(i, j) to be the maximum profit achievable with j buys
    ...
    # k_sum[i/2] - maximum money after perform k - 1 transactions before day i and buy at day i
    # k_sum[i/2 + 1] - maximum money after selling the k-th stock at day i
